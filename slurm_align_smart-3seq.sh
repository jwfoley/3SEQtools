...
N_A=8
N_mismatch=1
star_options='--outFilterMultimapNmax 1 --outFilterMismatchNmax 999 --clip3pAdapterSeq AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA --clip3pAdapterMMp 0.2' # no multimappers reported and poly(A) clipped
time='1:00:00'
mail_type='FAIL'
